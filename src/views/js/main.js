...
pizzaIngredients.nonMeats = [ //for all the vegans out there
    "White Onions",
    "Red Onions",
    "Sauteed Onions",
    "Green Peppers",
...
String.prototype.capitalize = function() { // Capitalizes first letter of each word
    return this.charAt(0).toUpperCase() + this.slice(1); //The slice() method extracts parts of a string and returns the extracted parts in a new string
};

// Pulls adjective out of array using random numbers sent from generator
function getAdj(x) {
    switch (x) {
        case "dark":
...
var adjectives = ["dark", "color", "whimsical", "shiny", "noisy", "apocalyptic", "insulting", "praise", "scientific"]; // types of adjectives for the pizza titles
var nouns = ["animals", "everyday", "fantasy", "gross", "horror", "jewelry", "places", "scifi"]; // types of nouns for the pizza titles
...
var pizzaElementGenerator = function(i) {
    ...
    pizzaImageContainer.classList.add("col-md-6"); //using frameworks page layouts are easy to implement
    ...
    pizzaDescriptionContainer.classList.add("col-md-6"); //using frameworks page layouts are easy to implement
...
for (var i = 2; i < 30; i++) { // This for-loop actually creates and appends all of the pizzas when the page loads
...
function logAverageFrame(times) { // times is the array of User Timing measurements from updatePositions()
    ...
    console.log("Average scripting time to generate last 10 frames: " + sum / 10 + "ms"); //logs the average time to generate the last 10 frames on the page
}
